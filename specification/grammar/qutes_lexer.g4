...
QUINT_LITERAL
   : SQUARE_PARENTHESIS_OPEN QUBIT_LITERAL (COMMA (' ')* QUBIT_LITERAL)* SQUARE_PARENTHESIS_CLOSE //TODO: not implemented at the moment
   | MATH_SIGN? DIGIT+ QUBIT_LITERAL_POSTFIX
   ;
