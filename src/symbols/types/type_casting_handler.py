...
class TypeCastingHandler():
    ...
    type_promotable_to : dict[Enum, list[QutesDataType]] = {
        ...
        QutesDataType.int_array: [QutesDataType.bool_array],
        QutesDataType.float_array: [QutesDataType.bool_array, QutesDataType.int_array],
        QutesDataType.string_array: [QutesDataType.bool_array, QutesDataType.int_array, QutesDataType.float_array],
